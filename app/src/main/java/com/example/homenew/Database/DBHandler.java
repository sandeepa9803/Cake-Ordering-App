package com.example.homenew.Database;
...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public long addinfo(String productname, String modelname, String wattage, String warranty, String price, String s, String paymentmethod){
        ...
        values.put(OrderCake.Orders.COLUMN_1, productname);
        values.put(OrderCake.Orders.COLUMN_2, modelname);
        values.put(OrderCake.Orders.COLUMN_3, wattage);
        values.put(OrderCake.Orders.COLUMN_4, warranty);
        values.put(OrderCake.Orders.COLUMN_5, price);
